...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<Map<String, dynamic>> _pages = [
    ...
    },
    {
      ...
      'description':
          'Chaque engagement compte. Rejoignez la grande famille des partenaires de l\'AMI Côte d\'Ivoire. Que ce soit par un soutien mensuel ou un don ponctuel, votre participation devient un instrument puissant entre les mains de Dieu.',
